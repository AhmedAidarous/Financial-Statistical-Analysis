...
# combined_financials_cy.dropna(axis=1,inplace=True) #dropping columns with NaN valuescombined_financials_cy = {DataFrame: (92, 28)} AXP  ... WBA [Assets                                     Total assets  ... NaN] [Total assets                               19,13,67,000  ... NaN] [Liabilities and stockholders' equity        Liabilities  ... NaN] [Liabilities                           Tot...View as DataFrame
...
# The output is in sorted order, showing the stocks with the highest Piotroski F-Score, and those
# are the stocks that are the most desirable, because it signifies that a company is considered to have good value
